...
function toggleLoading(isLoading) {
  ...
  if (isLoading) {
    document.getElementById("submitButton").innerHTML = "<i class=\"fas fa-hourglass-half\"></i>Loading...";
    document.getElementById("submitButton").disabled = true;
  }
  else {
    document.getElementById("submitButton").innerHTML = "<i class=\"fas fa-search\"></i>Search";
